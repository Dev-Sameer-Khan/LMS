...
const AdminHome = () => {
  return (
    <section className='w-full min-h-screen bg-[#111828] pl-[20%] px-20 flex items-center justify-center'>
      <div className="bg-gray-800 border border-gray-700 p-10 rounded-2xl shadow-lg max-w-2xl text-center text-white">
        <h1 className="text-5xl font-extrabold">Welcome to the Admin Dashboard</h1>
