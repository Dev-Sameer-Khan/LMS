...
const Navbar = () => {
  return (
    <nav className='w-full fixed top-0 left-0 px-12 py-2 z-[99] bg-[#1E293B] text-white flex items-center justify-between font-[semibold] text-[1.1vw]'>

      <NavLink to="/" className="logo w-[4%]">
      <img src={logo} className='w-full h-full pointer-events-none object-cover' alt="" />
      </NavLink>
      ...
      <div className="btns flex items-center justify-between gap-2">
        <NavLink to="/login" className="py-2 px-4 bg-orange-600 rounded-sm">Login</NavLink>
        <NavLink to="/register" className="py-2 px-4 bg-orange-600 rounded-sm">Register</NavLink>
      </div>
